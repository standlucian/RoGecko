...
public:
    ...
    std::vector <double> smoothed, derivative;
...
public slots:
    ...
    void setPlotState(int);
    void maximumFinder();

signals:
    void histogramCleared(unsigned int, unsigned int);
    void changeZoomForAll(unsigned int, double, double);
...
private:
    ...
    void drawLogTicks(QPainter &);
    void drawSqrtTicks(QPainter &);
    void drawChannels(QPainter &);
    void drawChannel(QPainter &, unsigned int id);
    void drawLogChannel(QPainter &, unsigned int id);
    void drawSqrtChannel(QPainter &, unsigned int id);
